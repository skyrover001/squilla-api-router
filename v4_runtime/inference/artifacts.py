...
class V3FeatureRuntime:
    ...
    def __init__(self, tfidf_vectorizer: Any, svd_model: Any) -> None:
        self._tfidf = tfidf_vectorizer
        self._svd = svd_model

    def extract_handcrafted(self, text: str) -> np.ndarray[Any, Any]:
        from squilla_api_router.v4_runtime.features import extract_handcrafted

        return extract_handcrafted(text).astype(np.float32)

    def extract_tfidf(self, text: str) -> np.ndarray[Any, Any]:
    ...
    def extract_context(self, metadata: dict[str, Any]) -> np.ndarray[Any, Any]:
        from squilla_api_router.v4_runtime.features import (
            ContextMetadata,
    ...
    def extract_hist(
        ...
        from squilla_api_router.v4_runtime.features import extract_hist_features
...
class InferenceArtifacts:
    ...
    def load_runtime_objects(
        ...
        *,
        ...
        from squilla_api_router.v4_runtime.v4_features import BGEChannelExtractor
        ...
        mlp_session = create_cpu_inference_session(paths["mlp_onnx"])
